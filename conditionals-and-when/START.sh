...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║      RHCE KILLER — conditionals and when Exam Starting           ║"
echo "╠══════════════════════════════════════════════════════════════╣"
echo "║                                                              ║"
...
echo "║                                                              ║"
echo "║  Read the exam at: ~/exams/conditionals-and-when/README.md        ║"
echo "║  Grade yourself  : bash ~/exams/conditionals-and-when/grade.sh    ║"
echo "║                                                              ║"
...
while true; do
  ...
  if [ "$REMAINING" -le 0 ]; then
    ...
    echo "╔══════════════════════════════════════════╗"
    echo "║           ⏰  TIME IS UP!                 ║"
    echo "║   Run: bash ~/exams/conditionals-and-when/grade.sh     ║"
    echo "╚══════════════════════════════════════════╝"
    break
  fi
