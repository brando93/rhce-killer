...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║   RHCE KILLER — Data Manipulation & Filters Exam Starting       ║"
echo "╠══════════════════════════════════════════════════════════════════╣"
echo "║                                                                  ║"
...
echo "║                                                                  ║"
echo "║  Read the exam at: ~/exams/data-manipulation-and-filters/README.md║"
echo "║  Grade yourself  : bash ~/exams/data-manipulation-and-filters/grade.sh║"
echo "║                                                                  ║"
...
while true; do
  ...
  if [ "$REMAINING" -le 0 ]; then
    ...
    echo "╔════════════════════════════════════════════════════════════╗"
    echo "║                  ⏰  TIME IS UP!                            ║"
    echo "║  Run: bash ~/exams/data-manipulation-and-filters/grade.sh  ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    break
  fi
